...
$lines.Add('    -- Если ТА уже существует в БД (по SerialNumber), обновляем внешний GUID из ресурсов.')
$lines.Add('    UPDATE vm')
$lines.Add('    SET vm.ExternalId = i.ExternalId')
$lines.Add('    FROM dbo.VendingMachine vm')
$lines.Add('    INNER JOIN #VendingMachineImport i ON i.SerialNumber = vm.SerialNumber')
$lines.Add('    WHERE vm.ExternalId <> i.ExternalId;')
$lines.Add('')
...
$lines.Add('    FROM #VendingMachineImport i')
$lines.Add('    INNER JOIN dbo.VendingMachine vm ON vm.ExternalId = i.ExternalId;')
$lines.Add('')
